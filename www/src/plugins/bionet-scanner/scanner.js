...
const scanner = {
    ...
    onLoadComplete: function (resources) {
        ...
        const cameraButton = utils.clickSprite(scanTray, this.assets + 'scannerTrayCamera.svg', this.assets + 'scannerTrayCameraActive.svg', 1034, 99, function (e) {
        ...
        this.startScan = function (e, highlight) {
            console.log('scanner startScan function')
            toggleScan = true
        ...
        // toggle tray button
        var toggleTray = true
        const trayButton = utils.clickSprite(scanTray, this.assets + 'scannerTrayButton.svg', this.assets + 'scannerTrayButtonActive.svg', 963, 898, function (e) {
        ...
        console.log('scanner onLoadComplete finished')
    }
}
